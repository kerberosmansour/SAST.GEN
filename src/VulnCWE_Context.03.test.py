...
4. **Focus on Accurate Detection:**
   ...
   - Discuss in as much detail common input validation routnines, the specific input vairables it's looking to avoid and that they should check for between source and sinks to avoid the {cwe_name} vulnerability.
