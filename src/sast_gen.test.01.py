...
def save_output(language, cwe, content):
    ...
    output_path = os.path.join("/Users/sherif/Documents/GitHub/SVPS/SAST/Swift", output_file_name)
...
def main():
    base_dir = "/Users/sherif/Documents/GitHub/SVPS/VulnsContext/Swift"
    context_file = "/Users/sherif/Documents/GitHub/SVPS/Semgrep.output.md"
